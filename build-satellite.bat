...
set SRC_FILES=src/platform/windows/main.cpp src/platform/windows/globals.cpp src/platform/windows/config.cpp src/platform/windows/crypto.cpp src/platform/windows/vigem.cpp src/platform/windows/tray.cpp src/platform/windows/vigem_adapter.cpp src/adapters/client_adapter.cpp src/net/receiver.cpp src/net/webserver.cpp src/net/pairing.cpp src/net/discovery.cpp src/core/session_service.cpp src/adapters/log_adapter.cpp
