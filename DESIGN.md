...
| Var | Value | Role |
|---|---|---|
| `--bg` | `#0D0F12` | Body background |
| `--surface` | `#161A1F` | Card / raised panel |
| `--surface-dim` | `#111417` | Recessed / empty state |
| `--outline` | `#222831` | Borders / dividers |
| `--primary` | `#FFC107` | Main accent (amber) |
| `--primary-mid` | `#C27A2C` | Secondary state (slider on, btn-stop hover, btn-save hover) |
| `--primary-dim` | `#A65F1E` | Pressed / disabled primary, btn-stop bg, btn-save bg |
...
- [web/img/ctrl-playstation.svg](web/img/ctrl-playstation.svg) — third-party
  brand colors: `#003087`, `#7BC8A4`, `#E8555D`, `#C8A2D4`, `#6B9FD4`,
  `#fff`.
