...
/*
 * crypto.cpp — SHA-256, sessions, PIN, credentials, libsodium wrappers (macOS)
 */
#include "crypto.h"
#include "config.h"
...
// Stored alongside the config in ~/Library/Application Support/satellite/,
// mode 0600. This is the practical macOS equivalent of DPAPI's user-scoped
// master key; stronger would be Keychain, which pulls in much more surface.
