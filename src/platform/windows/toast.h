...
// Shell_NotifyIcon balloons can't carry buttons, so use a WinRT toast whose
// buttons are activationType="protocol" (a satellite-pair: URI) rather than a
// COM activator: MinGW ships no WRL. The launched process forwards the URI to
