...
// Bonjour/Avahi senders (and subnets that drop the broadcast beacon) discover
// us. Additive — runs alongside the legacy beacon, never a replacement.
//
...
// Runs until `g_appRunning` clears. A bind failure (e.g. another responder
